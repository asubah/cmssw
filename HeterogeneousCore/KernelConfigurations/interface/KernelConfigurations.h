...
namespace cms {
  ...
  class KernelConfigurations {
    public:
      ...
      static void fillKernelDescriptions(edm::ParameterSetDescription& desc,
          std::vector<std::tuple<
                        std::string, // kernel name
                        std::vector<uint32_t>, // threads
                        std::vector<uint32_t>, // blocks
                        std::vector<uint32_t>, // minThredas
        ...
        for (auto kernelDesc : kernelsDescs) {
          ...
          configsDesc.add<std::vector<uint32_t>>("minThredas", minThreads);
          ...
          defaultConfigsDesc.addParameter<std::vector<uint32_t>>("minThredas", minThreads);
